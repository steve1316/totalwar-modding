...
It covers six generator runs: `process_main_units_tables.py`, `update_dynamic_rors.py --reset`, `update_dynamic_rors.py --reset --vanilla`, `update_modified_attribute_mods.py --reset`, `update_double_unit_size.py --reset`, and `update_ttc_compat.py`. Each one is only re-run when something it depends on changed:
